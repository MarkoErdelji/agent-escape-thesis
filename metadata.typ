...
#let zadatak = [
     У оквиру овог рада потребно је испитати способност аутономних агената заснованих на великим језичким моделима да самостално открију и искористе познате рањивости контејнерске изолације. Потребно је спровести евалуацију на моделима различитих нивоа способности и анализирати у којој мери успешност зависи од категорије рањивости и величине модела. Верификација резултата заснива се на аутономном издвајању тајног податка из меморије суседног контејнера на истом домаћину.
]
